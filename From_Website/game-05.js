...
Game.mushroom = function(x, y) {
  ...
  Game.Animator.call(this, Game.mushroom.prototype.frame_sets["flash"], 15);//mushrooms flash animation
...
Game.World.prototype = {
  ...
  setup:function(zone) {
    ...
    this.doors              = new Array();//this  function is to move from one level to another- can do this if time permits
