...
/* Game Animator frame change loop fuction  */
...
this will be used to design the collision map-- all of these were coded
during development of the game and can be used for future more advanced levels.
Currently on few are used for the tree levels*/
...
Game.mushroom = function(x, y) {
  ...
  Game.Animator.call(this, Game.mushroom.prototype.frame_sets["flash"], 15);//mushrooms flash animation-- mushroom swap between the two frames
...
//Game door function was intended to be used for swap between different levels-- for now this is kept for future levels 
...
/* Game player function for calling the player poition*/
...
/*Frame sets for player to move-- sprite animation */
...
Game.TileSet = function(columns, tile_size) {
  ...
  this.frames = [new f(253, 1721, 60, 80, 10, -58), new f(383, 1721, 60, 80, 10, -58),new f(502, 1721, 60, 80, 10, -58),new f(4, 1847, 60, 80, 10, -58),// idle-left
                 ...
                 new f(380, 594, 60, 65, 0 , -5), new f(510, 594, 60, 65, 0, -5) // Mushroom
...
Game.World.prototype = {
  ...
  setup:function(zone) {
    ...
    this.doors              = new Array();//this  function is to move from one level to another- this is for future development
